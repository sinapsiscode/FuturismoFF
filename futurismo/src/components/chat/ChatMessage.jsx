          ...
          {message.type === 'location' && (
            <div className="cursor-pointer">
              ...
              <div className="mt-2 h-32 bg-gray-200 rounded overflow-hidden">
                <img 
                  src={`https://maps.googleapis.com/maps/api/staticmap?center=${message.location.lat},${message.location.lng}&zoom=15&size=300x150&markers=${message.location.lat},${message.location.lng}&key=YOUR_API_KEY`}
                  alt={t('chat.map')}
